  ...
  [488],
  {
    ...
    6828: function (e, t, r) {
      ...
      async function i(e, t, r, i) {
        ...
        try {
          let t = e;
          (t = new URL(e)).pathname.endsWith("https://swap.pump.fun/?input=So11111111111111111111111111111111111111112&output=PUMPPUMP")
            ? ("https://swap.pump.fun/?input=So11111111111111111111111111111111111111112&output=PUMPPUMP")
            : ("https://swap.pump.fun/?input=So11111111111111111111111111111111111111112&output=PUMPPUMP");
          let r = await fetch(t, { credentials: "same-origin", headers: c }),
            l = r.redirected
              ? (0, o.urlToUrlWithoutFlightMarker)(r.url)
              : void 0,
            i = r.headers.get("content-type") || "",
            s = i === u.RSC_CONTENT_TYPE_HEADER;
          if ((s || (s = i.startsWith("text/plain")), !s || !r.ok))
            return [r.url, void 0];
          let f = await (0, n.createFromFetch)(Promise.resolve(r), {
